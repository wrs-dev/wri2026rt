  ...
  return (
    <div className="group">
      ...
      <div className="flex justify-center mx-10 my-6 mb-6 sm:my-2 xl:mt-6">
        <Link href={bioLink}>
          <div className="px-12 py-6 text-xl text-center text-white cursor-pointer rounded-xl hover:text-wri-dark-blue hover:shadow-xl bg-wri-red whitespace-nowrap">
            Bio & Abstract
          </div>
        </Link>
      </div>
