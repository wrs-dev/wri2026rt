        ...
        <div classname="flex">
          <figure>
            <Image
              ...
              height={200}
              alt="Principles icon"
              className="w-full fill-current text-wri-green"
            />
          </figure>
          <h2 className="mt-4 text-2xl text-wri-green">ABSTRACT</h2>
        </div>
      </div>
      <div className="w-full p-8 md:w-4/5 bg-wri-green/20">
        <h2 className="mb-6 text-2xl font-bold text-wri-green">{topic}</h2>
