    ...
    >
      <div className="w-full md:w-2/5 xl:w-1/6 xl:mx-24 mb-20 lg:mb-8">
        <div className="relative">
          <div className="aspect-w-2 aspect-h-1 xl:w-full overflow-hidden border-t-4 border-wri-red">
            <img
              src={imageSrc}
              alt={name}
        ...
        <div classname="flex">
          <figure>
            <Image
              ...
              height={200}
              alt="Principles icon"
              className="w-full text-wri-red fill-current"
            />
          </figure>
          <h2 className="text-2xl text-wri-red mt-4">ABSTRACT</h2>
        </div>
      </div>
      <div className="w-full md:w-4/5 bg-wri-red/10 p-8">
        <h2 className="font-bold text-wri-red text-2xl mb-6">{topic}</h2>
